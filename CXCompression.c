...
static void HuffInitTable(struct HuffTable *param_1, void *work, u16 param_3) {
  ...
  param_1->at_0x04 = (byte_t *)((size_t)work + 0x3000);
  param_1->at_0x08 = (struct at8 *)((size_t)param_1->at_0x04 + 0x200);
  param_1->at_0x0c = 1;
...
static void HuffMakeHuffTree(struct HuffTable *param_1,
                             unk2_t unsigned param_2) {
  s16 i;
